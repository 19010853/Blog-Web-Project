    ...
    <>
      ...
      <section className="lg:px-33 px-5 lg:my-30 my-10">
        <div className="relative">
          ...
          <Image
            width={500}
            height={500}
            src="/assets/elements/hero-7-top-dots.png"
            className=" absolute left-[10rem] -top-1 -z-1"
            alt=""
          />
          <Image
            width={500}
            height={500}
            src="/assets/elements/arrow-1.png"
            className="hidden lg:block absolute right-[15rem] top-5 w-[20rem] -z-1"
            alt=""
          />
          <Image
            width={500}
            height={500}
            src="/assets/elements/shape-left-2.png"
            className="left-[-20rem] absolute top-[20rem] -z-1"
            alt=""
          />
          <Image
            width={800}
            height={800}
            src="/assets/elements/blob.png"
            className="right-[10rem] absolute top-[5rem] -z-1"
            alt=""
          />
        </div>
              ...
              {articles?.slice(0, 2)?.map((article, index) => (
                <div className="mb-4 flex gap-2 border border-[#9498ff34] p-2 rounded-xl">
                  <Image
                    ...
                    height={100}
                    src={article?.thumbnail}
                    className="h-20 w-20 object-cover roundedmd"
                  />
      ...
      <section className="lg:px-33 px-5 lg:my-30 my-10">
        <div className="mb-10 relative">
          ...
          <p className="italic font-normal text-sm mt-2 text-gray-500">
          ...
          <Image
            ...
            height={500}
            src="/assets/elements/shape-left-2.png"
            className="left-[-20rem] absolute top-0 -z-1"
            alt=""
          />
          <Image
            width={800}
            height={800}
            src="/assets/elements/blob.png"
            className="right-[-15rem] absolute top-[-20rem] -z-1"
            alt=""
          />
        </div>
        <div>
      ...
      <section className="lg:px-33 px-5 lg:my-30 my-10">
        <div className="mb-10 relative">
          ...
          <Image
            ...
            height={300}
            src="/assets/elements/shape-left-2.png"
            className="absolute left-[-20rem] -z-1 top-[30rem]"
            alt=""
          />
          <Image
            width={500}
            height={300}
            src="/assets/elements/orange-blob.png"
            className="absolute right-[-15rem] -z-1 top-[-5rem] w-[40rem]"
            alt=""
          />
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-7">
