  ...
  return (
    <div>
      <header className="flex flex-row justify-between items-center bg-indigo-800 my-5 mx-5 lg:mx-33 px-2 py-4 rounded-full">
        ...
        <Menubar
          className={
            "text-white bg-[#0000] border-0 shadow-none hidden lg:flex"
          }
        >
          <MenubarMenu>
            <MenubarTrigger>
        ...
        <div className="flex gap-4 items-center">
          <Dialog>
            ...
            <DialogContent
              className={
                "max-w-xl text-white bg-[#050510] border-1 border-gray-800"
              }
            >
              <DialogHeader>
          ...
          <Dialog>
            ...
            >
              <DialogHeader>
                <input
                  type="text"
                  className="border-1 border-[#0b0b24] bg-[#08081a] rounded-lg py-2 outline-0 focus:ring-indigo-500 focus:ring-2 px-2 placeholder:text-sm text-[#7070b2]"
