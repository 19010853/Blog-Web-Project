      ...
      <section className="lg:px-33 px-5 my-20 z-10 relative">
        ...
        <div className="flex items-center gap-3 mt-10">
          ...
          <button
            ...
            className="p-2 px-4 bg-indigo-800 rounded-lg"
          >
            {bookmarking ? (
                ...
                <div className="space-y-5 relative">
                  <div className="flex flex-col items-start gap-2">
                    ...
                    <input
                      ...
                      type="text"
                      value={profile?.full_name || "Unknown Writer"}
                      readOnly
                  ...
                  <div>
                    <button
                      ...
                      className=" lg:flex bg-gradient-to-r from-indigo-500 to-pink-500 cursor-pointer text-[15px] font-bold px-6 py-3 rounded-full border-0 me-3"
                    >
                      {submitting ? (
                        <>
                          Submitting...{" "}
              ...
              <div className="mt-10">
                ...
                <div className="space-y-6">
                  {comments?.map((comment, index) => (
                    <div
                      className="bg-[#07050D] border border-[#110c1f] p-5 rounded-xl"
                      key={comment?.id}
                    >
