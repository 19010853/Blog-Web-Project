  ...
  const fetchDashboardData = async () => {
    ...
    const [
      ...
      supabase
        .from("comment")
        .select(
          "id, comment, date_created, profile:profile_id(full_name, image)"
        )
    ...
    <div>
      ...
      <section className="lg:px-33 px-5 my-20 space-y-10 z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div
            className="p-5 rounded-lg bg-[#07050D] border border-[#110c1f] space-y-8"
              ...
              {articles?.map((article, index) => (
                <div className="border border-[#110c1f] py-5 me-2">
                  ...
                  <div className="flex justify-end gap-3 mt-3">
                    ...
                    <Link
                      href={`/dashboard/article/manage?id=${article?.id}`}
                    ...
                    <button
                      ...
                      className="h-10 w-10 flex items-center justify-center bg-red-700 rounded-md"
                    >
