  ...
  const notifications = [
    {
      ...
      type: "comment",
      message:
        "Jane Doe commented on your article 'Exploring the Future of Tech'.",
      is_read: false,
      article_id: 3,
    ...
    },
    {
      ...
      type: "like",
      message:
        "Michael Smith liked your article '10 Habits of Highly Effective People'.",
      is_read: false,
      article_id: 5,
      receiver_id: "user-uuid-123",
    ...
    },
    {
      ...
      type: "comment",
      message:
        "Emily Carter replied to your comment on 'The Rise of Remote Work Culture'.",
      is_read: false,
      article_id: 7,
      receiver_id: "user-uuid-123",
  ...
  const comments = [
    {
      ...
      article_id: 1,
      comment:
        "Really insightful post! The tips on writing engaging content are spot on.",
    ...
    },
    {
      ...
      article_id: 1,
      comment:
        "Thanks for breaking it down clearly. I especially liked the section on SEO basics.",
    ...
    },
    {
      ...
      article_id: 1,
      comment:
        "Great read! Looking forward to trying some of these techniques in my own writing.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          {stats?.map((stat, index) => (
            <div className="p-5 rounded-lg flex items-center gap-6 bg-[#07050D] border border-[#110c1f]">
              <i
                className={`${stat.icon} text-3xl p-3 rounded-lg ${stat?.bg} ${stat?.text}`}
              ></i>
              <div>
              ...
              {articles?.map((article, index) => (
                <div className="border border-[#110c1f] py-5 me-2">
                  ...
                  <div className="flex justify-end gap-3 mt-3">
                    <Link
                      href="/"
                      className="h-10 w-10 flex items-center justify-center bg-green-700 rounded-md"
                    >
                      <i className="fas fa-eye"></i>
                    </Link>
                    <Link
                      href="/"
                      className="h-10 w-10 flex items-center justify-center bg-blue-700 rounded-md"
                    >
                  ...
                  <i
                    className={`fas ${
                      notification?.type === "comment"
                        ? "fa-comment bg-purple-200 text-purple-600"
                        : "fa-thumbs-up bg-blue-200 text-blue-600"
